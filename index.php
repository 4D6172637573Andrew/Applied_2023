...
<div class="card-body">
    ...
    <p class="card-text">A software solution that has been researched and designed using knowledge gained througout the year.</p>
    <a href="paycal.php" class="btn btn-outline-warning">Go To PAYCAL®</a>
  </div>
</div>
  </div><!-- /.col-lg-4 -->
...
<div class="card-body">
    ...
    <p class="card-text">Create<br>Read<br>Update<br>Delete</p>
    <a href="Data_select.php" class="btn btn-outline-warning">Go To Read (View - Select)</a>
  </div>
</div>
  </div><!-- /.col-lg-4 -->
...
<div class="row featurette">
  <div class="col-md-7">
    <h2 class="featurette-heading fw-normal lh-1">First featurette heading. <span class="text-body-secondary">HEHEHEHAW.</span></h2>
    <p class="lead">HEHEHEHAW</p>
  </div>
  <div class="col-md-5">
  <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false">
  <rect width="100%" height="100%" fill="var(--bs-secondary-bg)" />
...
<div class="row featurette">
  <div class="col-md-7 order-md-2">
    ...
    <p class="lead">Another featurette? Get rid of it lmao. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place.</p>
  </div>
        ...
        <div class="carousel-item active">
            ...
            <div class="container">
                <div class="carousel-caption text-start">
                    <h1>Hello Bobby.</h1>
                    <p>Hello Bobby.</p>
                    <p><a class="btn btn-lg btn-primary" href="#">Sign up to Hello Bobby!</a></p>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Hello Bobby.</h1>
                    <p>Hello Bobby.</p>
                    <p><a class="btn btn-lg btn-primary" href="#">Learn more of Hello Bobby!</a></p>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption text-end">
                    <h1>Hello Bobby.</h1>
                    <p>Hello Bobby.</p>
                    <p><a class="btn btn-lg btn-primary" href="#">Browse the  Hello Bobby gallery</a></p>
                </div>
            </div>
        </div>
    </div>
