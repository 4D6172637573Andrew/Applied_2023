...
if (str_replace(" ", "", $_SESSION["displayWord"]) === str_replace(" ", "", $_SESSION["randomWord"]) && !empty($_SESSION["displayWord"])) {
    ...
    $message = "<b><br>YOU LOST!!! The word was: </b>" . $_SESSION["randomWord"] . ".";
    session_unset();
    session_destroy();
}
?>
...
<div class="hangman-container">
    ...
    <div>
        ...
        <?php else : ?>
            ...
            <form method="POST" action="">
                <button  class="btn btn-outline-warning" type="submit" name="reset">Reset Game</button>
            </form>
        <?php endif; ?>
    </div>
</div>
