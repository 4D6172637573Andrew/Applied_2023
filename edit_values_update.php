<?php
if (!empty($_POST)) {
    if (isset($_POST['edit_values_rate'], 
    $_POST['edit_values_uni_allow'], 
    $_POST['edit_values_lau_allow'], 
    $_POST['edit_values_pm_allow'], 
    $_POST['edit_values_s_date'], 
    $_POST['edit_values_s_time'], 
    $_POST['edit_values_e_time'], 
    $_POST['id'])) {
